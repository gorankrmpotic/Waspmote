...
//	private String password = "admin";
	...
	public void OkButtonClicked(View view)
	{
		...
		//ako provjera proï¿½e napraviti ovo, ako ne onda ponoviti login!
...
//		if(usernameInput.getText().toString().equals(username) && passwordInput.getText().toString().equals(password))
		...
		//u redu je ovako da se ubije trenutni activity jer onda prilikom backa samo baci na poï¿½etni zaslon :)
	...
	public User getLoginUserData(String username)
	{
		...
		{
			//do ovoga dolazi ako se ništa ne pronaðe zasad!
